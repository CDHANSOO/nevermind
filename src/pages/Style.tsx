      ...
      <div>
        <div className="mt-[60px]">
          <p className="text-gray-600">
            트렌드를 따라가는 것, 멋있는 일이지만 동시에 번거로운 일이죠.
            <br />
            놀랍도록 간단하게 실시간 인기 있는 패션들을 살펴보세요
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mb-3 w-fit">
            <ul className="inline-flex justify-start items-start gap-3">
              <li className="text-base font-bold">인플루언서</li>
              <li className="text-base font-bold">걸그룹</li>
              <li className="text-base font-bold">보이그룹</li>
              <li className="text-base font-bold">유명인</li>
              <li className="text-base font-bold">연예인</li>
            </ul>
