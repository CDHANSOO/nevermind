      ...
      <div className="flex justify-center items-center h-screen relative z-10">
        <div className="w-[500px] max-h-[auto] mt-[60px] border-2 border-white rounded-[10px] flex flex-col items-center bg-white bg-opacity-90">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input type="email" value={email} onChange={handleEmailChange} ref={emailRef} className="w-[250px] ml-8 mb-5 border-b-2 focus:outline-none focus:border-[#b980ff]" placeholder="   E-mail" />
            <input type='button' value='중복확인' className="w-[80px] h-[30px] rounded-[3px] mr-8 bg-[#b980ff] text-white hover:bg-violet-400" onClick={duplHandle}/>

            {/* 이름 작성 부분 */}
            <div className="ml-10 mr-8">이름</div>
            <input type="text" value={name} onChange={handleNameChange} ref={nameRef} className="w-[250px] ml-8 mr-8 mb-5 border-b-2 focus:outline-none focus:border-[#b980ff]" placeholder="   Name" />

            {/* 닉네임 작성 부분 */}
            <div className="ml-10 mr-8">닉네임</div>
            <input type="text" value={nick} onChange={handleNickChange} ref={nickRef} className="w-[250px] ml-8 mr-8 mb-5 border-b-2 focus:outline-none focus:border-[#b980ff]" placeholder="   Nick" />

            {/* 생년월일 작성 부분 */}
            <div className="ml-10 mr-8">생년월일</div>
            <input type="date" value={birth} onChange={handleBirthChange} ref={birthRef} className="w-[250px] ml-8 mr-8 mb-5 border-b-2 focus:outline-none focus:border-[#b980ff]" placeholder="Birth" />

            {/* 비밀번호 작성 부분 */}
            <div className="ml-10 mr-8">비밀번호</div>
            <input type="password" value={password} onChange={handlePasswordChange} ref={passwordRef} className="w-[250px] ml-8 mb-5 border-b-2 focus:outline-none focus:border-[#b980ff]" placeholder="   Password" />
