...
const MainCom = ({img}: Props) => {
  return (
    <>
      <div className='relative w-full h-[clac(100vh-70px)] top-[70px]'>
        <div className='flex justify-center'>
          <div className='pl-[100px] w-[720px] h-[720px] bg-[white] flex flex-col justify-center item-center rounded-[10px] mr-[25px]'>
            <div className=''>
          ...
          <div className='w-[720px] h-[720px] ml-[25px]'>
