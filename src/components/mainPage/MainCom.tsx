    ...
    <>
      <div className='relative w-full h-[clac(100vh-70px)] top-[70px]'>
        <div className='flex justify-center'>
          <div className='pl-[40px] w-[720px] h-[720px] bg-[white] border-black border-[1px] flex flex-col justify-center item-center rounded-[10px] mr-[25px]'>
            <div className=''>
          ...
          <div className='w-[720px] h-[720px] bg-[url("/src/assets/contents.png")] bg-cover rounded-[10px] ml-[25px]'></div>
        </div>
      </div>
    </>
  );
