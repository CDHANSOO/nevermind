    ...
    <div className='flex justify-center items-center h-screen'>
      <div className='w-[450px] h-[480px] border-2 rounded-[10px] bg-white'>
        ...
        <div className='flex justify-center '>
          ...
          <div className="m-3 text-[13px]">회원가입</div>
        </div>
        <form action="" className='flex flex-col items-center '>
          ...
          <div className="flex items-left justify-start mr-[140px] mt-2">
            ...
            <label htmlFor="check" className="ml-2 text-[13px] ">ID 저장하기</label>
          </div>
          <button type='submit' className="w-[230px] h-[32px] bg-[#b980ff] rounded-[5px] text-white hover:scale-105 duration-100 mt-6 mb-1" >로그인</button>
        </form>
        ...
        <div className='flex justify-center'>
          <a href=""><div className='w-[40px] h-[40px] rounded-full m-4 hover:scale-105 duration-100'><img src="/img/naver.png" alt="" /></div></a>
          <a href=""><div className='w-[40px] h-[40px] rounded-full m-4 hover:scale-105 duration-100'><img src="/img/google.webp" alt="" /></div></a>
          <a href=""><div className='w-[40px] h-[40px] rounded-full m-4 hover:scale-105 duration-100'><img src="/img/kakao.png" alt="" /></div></a>
        </div>
      </div>
